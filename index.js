...
const main = async () => {
  ...
  for (let i = 0; i < 7; i++) {
    await page.click(
      "#renderPageContentWrapper > div.sc-a248ca06-0.eRLiuy > div > div.sc-ieecCq.gqWjcE > div.Areas_sharedContent__7t9bx.Areas_wideContent__pXXeM > div > div > div.Areas_sharedAreaSpan__iXmcP.Areas_areaSpanTwo__BJB4o > div:nth-child(4) > div:nth-child(5) > div > button"
    );
  ...
  const tagsEl = await page.$$("div.sc-15b24234-1.byyLFw");
